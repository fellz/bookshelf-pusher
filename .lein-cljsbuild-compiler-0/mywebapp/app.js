...
var iurl__118098 = [cljs.core.str("https://s3.amazonaws.com/chater/"),cljs.core.str(url.key)].join('');
return fetch.remotes.remote_callback.call(null,"store-image",cljs.core.PersistentVector.fromArray([iurl__118098,bid], true),(function (result){
if(!(cljs.core._EQ_.call(null,bid,"")))
{jayq.core.inner.call(null,jayq.core.$.call(null,[cljs.core.str("#book-img-"),cljs.core.str(bid)].join('')),[cljs.core.str("<img src='"),cljs.core.str(iurl__118098),cljs.core.str("'>")].join(''));
} else
{jayq.core.attr.call(null,jayq.core.$.call(null,"\uFDD0'#book-img"),"\uFDD0'book-img-url",iurl__118098);
}
...
var boid__118100 = jayq.core.attr.call(null,jayq.core.$.call(null,bid),"\uFDD0'bookid");
return jayq.core.toggle.call(null,jayq.core.$.call(null,[cljs.core.str("#image-loader-"),cljs.core.str(boid__118100)].join('')));
});
testpro.app.store_book = (function store_book(e){
jayq.core.prevent.call(null,e);
var author__118104 = jayq.core.val.call(null,jayq.core.$.call(null,"\uFDD0'#author"));
var title__118105 = jayq.core.val.call(null,jayq.core.$.call(null,"\uFDD0'#title"));
var iurl__118106 = jayq.core.attr.call(null,jayq.core.$.call(null,"\uFDD0'#book-img"),"\uFDD0'book-img-url");
fetch.remotes.remote_callback.call(null,"store-book",cljs.core.PersistentVector.fromArray([author__118104,title__118105,iurl__118106], true),(function (result){
...
var bid__118107 = this;
return testpro.app.show_img_loader.call(null,bid__118107,e);
}));
